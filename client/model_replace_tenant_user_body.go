...
// checks if the ReplaceTenantUserBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplaceTenantUserBody{}

// ReplaceTenantUserBody struct for ReplaceTenantUserBody
type ReplaceTenantUserBody struct {
	...
	CreatedFromTenantId *string `json:"createdFromTenantId,omitempty"`
	LastLoginDate *float64 `json:"lastLoginDate,omitempty"`
	Karma *float64 `json:"karma,omitempty"`
}

type _ReplaceTenantUserBody ReplaceTenantUserBody
...
// GetCreatedFromTenantId returns the CreatedFromTenantId field value if set, zero value otherwise.
func (o *ReplaceTenantUserBody) GetCreatedFromTenantId() string {
	if o == nil || IsNil(o.CreatedFromTenantId) {
		var ret string
		return ret
	}
	return *o.CreatedFromTenantId
}

// GetCreatedFromTenantIdOk returns a tuple with the CreatedFromTenantId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReplaceTenantUserBody) GetCreatedFromTenantIdOk() (*string, bool) {
	if o == nil || IsNil(o.CreatedFromTenantId) {
		return nil, false
	}
	return o.CreatedFromTenantId, true
}
...
// SetCreatedFromTenantId gets a reference to the given string and assigns it to the CreatedFromTenantId field.
func (o *ReplaceTenantUserBody) SetCreatedFromTenantId(v string) {
	o.CreatedFromTenantId = &v
}
...
// SetLastLoginDate gets a reference to the given float64 and assigns it to the LastLoginDate field.
...
func (o ReplaceTenantUserBody) MarshalJSON() ([]byte, error) {
...
func (o ReplaceTenantUserBody) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CreatedFromTenantId) {
		toSerialize["createdFromTenantId"] = o.CreatedFromTenantId
	}
...
func (o *ReplaceTenantUserBody) UnmarshalJSON(data []byte) (err error) {
	...
	varReplaceTenantUserBody := _ReplaceTenantUserBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReplaceTenantUserBody)

	if err != nil {
		return err
	}

	*o = ReplaceTenantUserBody(varReplaceTenantUserBody)

	return err
}

type NullableReplaceTenantUserBody struct {
	value *ReplaceTenantUserBody
	isSet bool
}

func (v NullableReplaceTenantUserBody) Get() *ReplaceTenantUserBody {
	return v.value
}

func (v *NullableReplaceTenantUserBody) Set(val *ReplaceTenantUserBody) {
	v.value = val
	v.isSet = true
}

func (v NullableReplaceTenantUserBody) IsSet() bool {
	return v.isSet
}

func (v *NullableReplaceTenantUserBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplaceTenantUserBody(val *ReplaceTenantUserBody) *NullableReplaceTenantUserBody {
	return &NullableReplaceTenantUserBody{value: val, isSet: true}
}

func (v NullableReplaceTenantUserBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplaceTenantUserBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
