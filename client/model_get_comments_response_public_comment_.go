...
// checks if the GetCommentsResponsePublicComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCommentsResponsePublicComment{}

// GetCommentsResponsePublicComment struct for GetCommentsResponsePublicComment
type GetCommentsResponsePublicComment struct {
...
type _GetCommentsResponsePublicComment GetCommentsResponsePublicComment
...
func NewGetCommentsResponsePublicComment(status string, comments []PublicComment, user NullableUserSessionInfo, pageNumber int32) *GetCommentsResponsePublicComment {
	this := GetCommentsResponsePublicComment{}
	this.Status = status
...
func (o *GetCommentsResponsePublicComment) SetLastGenDateNil() {
...
func (o GetCommentsResponsePublicComment) MarshalJSON() ([]byte, error) {
...
func (o GetCommentsResponsePublicComment) ToMap() (map[string]interface{}, error) {
...
func (o *GetCommentsResponsePublicComment) UnmarshalJSON(data []byte) (err error) {
	...
	varGetCommentsResponsePublicComment := _GetCommentsResponsePublicComment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetCommentsResponsePublicComment)

	if err != nil {
		return err
	}

	*o = GetCommentsResponsePublicComment(varGetCommentsResponsePublicComment)

	return err
}

type NullableGetCommentsResponsePublicComment struct {
	value *GetCommentsResponsePublicComment
	isSet bool
}

func (v NullableGetCommentsResponsePublicComment) Get() *GetCommentsResponsePublicComment {
	return v.value
}

func (v *NullableGetCommentsResponsePublicComment) Set(val *GetCommentsResponsePublicComment) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCommentsResponsePublicComment) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCommentsResponsePublicComment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCommentsResponsePublicComment(val *GetCommentsResponsePublicComment) *NullableGetCommentsResponsePublicComment {
	return &NullableGetCommentsResponsePublicComment{value: val, isSet: true}
}

func (v NullableGetCommentsResponsePublicComment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCommentsResponsePublicComment) UnmarshalJSON(src []byte) error {
	v.isSet = true
